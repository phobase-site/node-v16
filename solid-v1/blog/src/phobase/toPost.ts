...
import {Column, getSelect, getStore, getValue} from "@phobase/site-config-core";
import {CATEGORY, IMAGE_URL, NAME, POSTED_AT, POSTER_IMAGE_URL, POSTER_NAME} from './constant';
