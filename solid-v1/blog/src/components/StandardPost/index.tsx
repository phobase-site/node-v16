...
const StandardPost: Component<Props> = ({post}) => {
  return <div class="cursor-pointer group">
    ...
    <div>
      <a href="/category/personal-growth">
        <span
          class="inline-block mt-5 text-xs font-medium tracking-wider uppercase text-emerald-700">Personal Growth</span>
      </a>
    </div>
    ...
    <div class="hidden">
      <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 line-clamp-3">
        <a href="/post/10-simple-practices-that-will-help-you-get-1-better-every-day">
          How do we become better every single day? We develop practices that will help move us incrementally forward.
          Small steps, taken
    ...
    <div class="flex items-center mt-3 space-x-3 text-gray-500 dark:text-gray-400">
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm">Erika Oliver</span></div>
      <span class="text-xs text-gray-300 dark:text-gray-600">•</span>
      <time class="text-sm" dateTime="2022-05-20T09:33:00Z">May 20, 2022</time>
    </div>
  </div>;
}
