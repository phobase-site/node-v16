...
const HeroPost: Component<Props> = ({post}) => {
  ...
  return <div class="cursor-pointer group">
    ...
    <div>
      <a href="#">
        <span
          class="inline-block mt-5 text-xs font-medium tracking-wider uppercase  text-blue-600">{post.category}</span>
      </a>
    </div>
    ...
    <div class="flex items-center mt-3 space-x-3 text-gray-500 dark:text-gray-400">
      ...
      <time class="text-sm" dateTime="2022-05-20T10:09:06Z">May 20, 2022</time>
    </div>
  </div>
}
